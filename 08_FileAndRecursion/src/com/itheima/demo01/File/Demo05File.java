...
public class Demo05File {
    ...
    private static void show01() throws IOException {
        // F:\Test\JavaSeLearn\08_FileAndRecursion这个路径必须存在！
        File f1 = new File("F:\\Test\\JavaSeLearn\\08_FileAndRecursion\\1.txt");
        boolean b1 = f1.createNewFile();
        System.out.println("b1:"+b1); //b1:true

        File f2 = new File("F:\\Test\\JavaSeLearn\\08_FileAndRecursion\\2.txt");
